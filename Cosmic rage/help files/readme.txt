...
***Character Name***. Normally the name you give your character within the Mud. Not filling this out will cause the pack to throw errors. Note. This can not be "Unnamed" This may also not contain spaces.
***Character Reference***. A unique name that VipMud uses to identify your character.  It is usually the same as your character name, or if you use this character in other Muds, a name closely related. Not filling this out will cause the pack to throw errors. Note. This can not be "Unnamed" This may also not contain spaces.
...
***Mud Name***. The name the Mud calls itself. For the pack to work correctly, the mud name must be "Cosmic rage." Be sure to include the space between Cosmic and Rage or else the pack can not load correctly.
